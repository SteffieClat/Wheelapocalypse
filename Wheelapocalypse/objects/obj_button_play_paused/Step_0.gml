...
if(gamepad_is_connected(0))
{
	...
	/// @DnDParent : 28C0B2B6
	/// @DnDArgument : "expr" "gamepad_button_check_pressed(0, gp_face1)"
...
/// @DnDArgument : "expr" "(keyboard_check_pressed(vk_escape)|| _gamepad_press) && !was_paused"
if((keyboard_check_pressed(vk_escape)|| _gamepad_press) && !was_paused)
{
	...
	/// @DnDVersion : 1
	/// @DnDHash : 46F4A540
	/// @DnDComment : // Sets was paused state
	/// @DnDParent : 0B6B032B
	/// @DnDArgument : "expr" "true"
